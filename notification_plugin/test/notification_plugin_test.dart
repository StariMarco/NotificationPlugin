...
void main() {
  final NotificationPluginPlatform initialPlatform =
      NotificationPluginPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockNotificationPluginPlatform fakePlatform =
        MockNotificationPluginPlatform();
